class MoedaModel {
  ...
  MoedaModel({this.name, this.real, this.dolar, this.euro, this.bitcoin});

  static List<MoedaModel> getCotacoes() {
    return <MoedaModel>[
      MoedaModel(
      ...
      MoedaModel(
        name: 'Bitcoin', real:64116.51, dolar: 112351.30, euro: 9689.54, bitcoin: 1.0
      ),
    ];
  }
}
